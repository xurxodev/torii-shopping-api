...
import SuggestionRepository from "../../domain/suggestions/boundaries/SuggestionRepository";
import { Suggestion, SuggestionCategory } from "../../domain/suggestions/entities/Suggestion";
            ...
            fetch(`https://completion.amazon.co.uk/api/2017/suggestions?mid=A1RKKUPIHCS9HS&alias=aps&prefix=${prefix}`)
                ...
                .then((resJson: any) => {
                    const suggestions = resJson.suggestions.map((sug: any) => {
                        ...
                        return {
                            categories: scopes ? scopes.map((scope: any) => {
